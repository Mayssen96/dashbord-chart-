...
@Component({
  selector: 'app-destination-categories',
  templateUrl: './destination-categories.component.html',
  styleUrls: ['./destination-categories.component.scss']
})
export class DestinationCategoriesComponent implements OnInit {
